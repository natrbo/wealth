...
function tabNetWorth(m){
  ...
  m.innerHTML=head+assetsCard+liabSummaryCard+incomeCard+crudAssetsCard+crudLiabCard+crudBizCard+crudReCard+crudIncCard+crudCashFlowCard+crudInsuranceCard;
}
