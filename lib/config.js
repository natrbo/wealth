...
const SEED = {
  ...
  nut: {
    assets:[
      ...
      {id:"n_esg_e",   bucket:"SCB",    name:"SCBTM(ThaiESG) หุ้น",       asset_class:"thai_equity", value:0, plan:7400},
      {id:"n_esg_f",   bucket:"SCB",    name:"SCBTM(ThaiESG) ตราสารหนี้", asset_class:"fixed",       value:0, plan:2600},
