...
const CLASSES = {
  ...
  dm_tech:    {label:"หุ้น Tech / Growth",       target:14, color:"#4DD0C7", ceiling:18},
...
const SEED = {
  fern: {
    assets:[
      {id:"pvd_f",    bucket:"PVD",     name:"MRT-F ตราสารหนี้",         asset_class:"fixed",       value:377560.80, plan:0},
      {id:"pvd_e",    bucket:"PVD",     name:"MRT-E หุ้นไทย",            asset_class:"thai_equity", value:226536.48, plan:0},
      {id:"pvd_fif_t",bucket:"PVD",     name:"MRT-FIF (Tech)",            asset_class:"dm_tech",     value:30205,     plan:0},
      {id:"pvd_fif_c",bucket:"PVD",     name:"MRT-FIF (กระจาย)",          asset_class:"dm_core",     value:120819,    plan:0},
      ...
      {id:"f_gnp_t",  bucket:"RMF",     name:"KKP GNP RMF-UH (Tech)",    asset_class:"dm_tech",     value:0,         plan:3300},
      {id:"f_gnp_c",  bucket:"RMF",     name:"KKP GNP RMF-UH (กระจาย)", asset_class:"dm_core",     value:0,         plan:7700},
  ...
  nut: {
    assets:[
      ...
      {id:"n_pvd_world",bucket:"PVD",  name:"PVDWORLD",            asset_class:"dm_core",     value:11842.86,plan:0},
      {id:"n_pvd_fi",   bucket:"PVD",  name:"PVDMPFFI",            asset_class:"fixed",       value:39938.50,plan:0},
      {id:"n_pvd_gold", bucket:"PVD",  name:"PVDMGLDH",            asset_class:"gold",        value:4323.20, plan:0},
    ],
