    ...
    <div class="app-container">
      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ${[["overview","ภาพรวม"],["update","อัปเดต"],["dca","แผน DCA"],["tax","ภาษี"],["networth","มูลค่าสุทธิ"]]
            .map(([k,l])=>`
...
function renderTab(){
  ...
  if(STATE.assets.length===0 && STATE.tab!=="tax" && STATE.tab!=="networth"){
  ...
  ({overview:tabOverview,update:tabUpdate,dca:tabDCA,tax:tabTax,networth:tabNetWorth}[STATE.tab])(m);
}
